...
=======================
Versão comunitária 1.0.4.pt_BR

Última atualização da versão original: 10 de abril de 2017

Última atualização da tradução: 5 de março de 2020

© 2014-2017 Red Hat e colaboradores | O Open Decision Framework foi criado pelo People team da Red Hat e está disponível sob licença Creative Commons Attribution-ShareAlike 4.0 International License ([CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)). Red Hat e o logo Shadowman são marcas registradas de Red Hat, Inc. registrada em outros países. Modificações precisam remover todas as marcas da Red Hat.

Notas
=========

* Esta versão markdown da apresentação tem por objetivo facilitar a colaboração e controle das mudanças.
* A numeração das páginas correspondem aos arquivos LibreOffice (.odp) e PDF no repositório.

Conteúdo
===========================================================================
* [Overview](#overview)
  * [O que é uma decisão aberta?](#o-que-eh-uma-decisao-aberta)
  * [Decisões abertas são feitas com os princípios de código aberto](#open-decisions-are-made-using-open-source-principles)
  * [Como os princípios de código aberto levam a melhores decisões](#how-open-source-principles-lead-to-better-decisions)
  * [É impossível agradar todo mundo](#you-cant-please-everyone)
* [Open Decision Framework](#open-decision-framework-1)
  * [Fase ou atividade: Conceitualização, Definição, Idealização](#phase-or-activity-concept-define-ideate)
  ...
  * [Fase ou atividade: Lançamento, Ativação, Conclusão](#phase-or-activity-launch-deploy-close)
* [Recursos](#resources)
* [Appendix](#appendix)
  * [Historia: De onde vem o Open Decision Framework](#history-where-the-open-decision-framework-came-from)
...
**O que é**
  - Uma estratégia aberta e flexível para a tomada de decisões de negócios e liderança de projetos

**Quando usar**

Para decisões e projetos que possivelmente vãoÇ
  - impactar nossa cultura ou
  - afetar associados além do seu time

**Como usar**
  - Construa passos do Open Decision Framework nos seus planos de projetos ou processos de decisão
...
<td>Transparente</td>
<td>Inclusivo</td>
<td>Centrada no client</td>
</tr>
<tr>
<td>Explique quem está tomando a decisão, que problemas você está tentando resolver, os requisitos e limitações envolvidas e o process que você seguirá.</td>
<td>Engage outros por feedback e colabore com o processo de decisão. Busque perspectivas diversas, incluindo potenciais detratações.</td>
<td>Pense nas pessoas como clientes com necessidades e prioridades. Quando uma decisão ajudará alguns clientes, mas desagradar outros, gerencie relacionamentos e espectativas enquanto trabalha.</td>
</tr>
</table>


Decisões abertas são feitas com os princípios de código aberto
-----------------------------------------------------
_página 4 de 15_ 
